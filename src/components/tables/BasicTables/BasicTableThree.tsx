...
return (
    <div className="rounded-2xl border border-gray-200 bg-white pt-4 shadow-sm dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            {reportes.map((r) => (
              ...
              >
                ...
                <td className="px-4 py-3 text-center whitespace-nowrap">
                  <button className="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 mr-2 transition-colors">
                    Editar
                  </button>
      ...
      {/* ⚙️ Footer de paginación estilo TailAdmin */}
          ...
          <ul className="hidden items-center gap-0.5 sm:flex">
            {[1, 2, 3, "...", 8, 9, 10].map((page, i) => (
              <li key={i}>
                <a
                  href="#"
                  className={`flex h-10 w-10 items-center justify-center rounded-lg font-medium text-theme-sm ${
                    page === 1
                      ? "bg-blue-500/10 text-blue-600 dark:text-blue-400"
                      : "text-gray-700 hover:bg-blue-500/10 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400"
                  }`}
                >
                  {page}
                </a>
